...
class _GitHubProfileCardState extends State<GitHubProfileCard>
      ...
      child: GestureDetector(
        ...
        child: AnimatedBuilder(
          ...
          builder: (context, child) {
            final isHovered =
                _hoverController.status == AnimationStatus.forward ||
                    _hoverController.status == AnimationStatus.completed;
  ...
  Widget _buildHeader(bool isHovered) => Row(
        children: [
  ...
  Widget _buildLanguages() => Column(
        ...
        children: [
          ...
          Wrap(
            spacing: 8,
            runSpacing: 6,
            children: widget.user.topLanguages
                .map(
                  (language) => Container(
                    padding:
            ...
            children: [
              IconButton(
                ...
                style: IconButton.styleFrom(
                  backgroundColor: AppTheme.borderGray.withValues(alpha: 0.2),
